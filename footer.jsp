...
<body>
	...
	<header id="header" id="home">
		...
		<div class="container main-menu">
			<div class="row align-items-center justify-content-between d-flex">
				<div id="logo">
					<a href="index.html"><img height="40" width="100" src="img/logo.png" alt="" title="" /></a>
				</div>
	...
	<footer class="footer-area section-gap">
		<div class="container">
			...
			<div align="center" class="footer-bottom d-flex justify-content-between align-items-center flex-wrap">
				<p class="col-lg-8 col-sm-12 footer-text m-0"><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Ruidas Services Private Limited
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
				...
				<div align="center" class="footer-social d-flex align-items-center">
			
							<a href="https://www.facebook.com/ruidasservicespvtltd"><i class="fa fa-facebook"></i></a>
							<a href="https://twitter.com/RuidasDotCom"><i class="fa fa-twitter"></i></a>
							<a href="mailto:sales@ruidas.com"><i class="fa fa-envelope"></i></a>
							<a href="https://www.linkedin.com/company/ruidas-services-private-limited"><i class="fa fa-linkedin"></i></a>
							<a href="https://www.instagram.com/ruidasservicespvtltd"><i class="fa fa-instagram"></i></a>
							<a href="https://github.com/ruidasservicespvtltd"><i class="fa fa-github"></i></a>
							<a href="https://www.youtube.com/channel/UCcOwfYstpg1-lYpQGBHck0Q"><i class="fa fa-youtube"></i></a>
							<a href="https://vk.com/ruidas"><i class="fa fa-vk"></i></a>
							<a href="#"><i class="fa fa-odnoklassniki"></i></a>
							<a href="https://ruidasservicespvtltdspace.quora.com/"><i class="fa fa-quora"></i></a>
